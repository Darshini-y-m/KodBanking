...
export default function UserDashboard() {
  ...
  useEffect(() => {
    fetch("https://kodbanking-o35b.onrender.com/api/auth/verify", { credentials: "include" })
      .then((res) => {
  ...
  const handleCheckBalance = async () => {
    setLoading(true);
    try {
      const res = await fetch("https://kodbanking-o35b.onrender.com/api/balance", { credentials: "include" });
